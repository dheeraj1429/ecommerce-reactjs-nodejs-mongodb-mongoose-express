...
function SideBarComponent() {
  ...
  return (
    <div className={!selector.CloseSidebar ? 'siderBar_overlay_div siderBar_overlay_div_active' : 'siderBar_overlay_div'}>
      <div className={!selector.CloseSidebar ? ' SideBar_div' : 'SideBar_div SideBar_div_active'}>
        <div className="sideBar_heading">
          <h4>My Cart</h4>
          <i className="fa fa-close" onClick={() => dispatch(closeSiderBar(!selector.CloseSidebar))}></i>
        </div>
        ...
        <div className="popUp_buttons_div">
          ...
          <div className="text-center mt-4">
            <CustomButtonComponent TextContent={'PROCEED TO CHECKOUT'} btnCl={'addToCartBtnOne'} />
          </div>
        </div>
      </div>
    </div>
