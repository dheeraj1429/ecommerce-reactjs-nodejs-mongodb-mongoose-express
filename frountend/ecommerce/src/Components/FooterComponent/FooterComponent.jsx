...
function FooterComponent() {
   const selector = useSelector((state) => state.userStoreData.SendNewsLetter);
            ...
            <div class="container-fluid ">
               <div class="footer-cta pt-5 pb-5 side_padding">
                  <div class="row">
                     <FooterCardComponent
                        heading={'Find us'}
                        subtitle={'1010 Avenue, sw 54321, chandigarh'}
                        icon={'fas fa-map-marker-alt'}
                     />
                     <FooterCardComponent
                        heading={'Call us'}
                        subtitle={'9876543210 0'}
                        icon={'fas fa-phone'}
                     />
                     <FooterCardComponent
                        heading={'Mail us'}
                        subtitle={'dheerajsingh1429@gmail.com'}
