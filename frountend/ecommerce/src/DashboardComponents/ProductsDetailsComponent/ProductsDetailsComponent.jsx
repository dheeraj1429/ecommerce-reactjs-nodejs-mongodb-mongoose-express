         ...
         {selector !== null && Object.keys(selector).includes('name') ? (
            <div className="row product_edit_inner_div p-4">
                     ...
                     {selector.galleryImage
                        ? selector.galleryImage.map((el) => (
                             <div className="product_sm_images_div mb-3">
                                {el.img == '' ? null : (
                                   <img src={el.img} alt="" onMouseEnter={ChangeImgFunction} />
                                )}
                             </div>
                          ))
                        : null}
                     ...
                     <div className="icons_divs d-flex mt-3">
                        <div className="me-2">
                           {(() => {
                              ...
                              return ar.map((el) => (
                                 <i class="fas fa-star" key={Math.random() * 100}></i>
                              ));
                           })()}
                        </div>
               ...
               <div className="Product_content_div mt-5 mb-4">
                  ...
                  <ReviewComponent
                     userProfile={
                        'http://skote-v-light.svelte.themesbrand.com/assets/images/users/avatar-2.jpg'
                     }
                     data={{
                        name: 'Dheeraj',
                        comment:
